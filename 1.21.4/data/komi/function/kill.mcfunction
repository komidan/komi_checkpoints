...
clear @a warped_fungus_on_a_stick[custom_data={komitool:1}]
clear @a warped_fungus_on_a_stick[custom_data={komitool:2}]
clear @a warped_fungus_on_a_stick[custom_data={komitool:3}]
